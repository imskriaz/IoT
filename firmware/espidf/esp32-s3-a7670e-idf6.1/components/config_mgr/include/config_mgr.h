...
typedef enum {
    CONFIG_CONNECTION_WIFI_ONLY = 0,
    CONFIG_CONNECTION_WIFI_CELLULAR_FALLBACK = 1,
    CONFIG_CONNECTION_CELLULAR_ONLY = 2,
    CONFIG_CONNECTION_CELLULAR_WIFI_FALLBACK = 3,
    CONFIG_CONNECTION_DUAL_ACTIVE_DEVELOPMENT = 4,
    CONFIG_CONNECTION_POLICY_COUNT
} config_connection_policy_t;
