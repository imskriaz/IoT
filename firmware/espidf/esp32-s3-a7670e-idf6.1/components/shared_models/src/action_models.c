...
const char *unified_action_command_name(unified_action_command_t command) {
    switch (command) {
        ...
        case UNIFIED_ACTION_CMD_WIFI_PROFILES_APPLY: return "wifi_profiles_apply";
        ...
        case UNIFIED_ACTION_CMD_DELETE_SMS: return "delete_sms";
        ...
        case UNIFIED_ACTION_CMD_MODEM_AT: return "modem_at";
        case UNIFIED_ACTION_CMD_STORAGE_INFO: return "storage_info";
        case UNIFIED_ACTION_CMD_GPIO_STATUS: return "gpio_status";
        case UNIFIED_ACTION_CMD_RESTART_MODEM: return "restart_modem";
