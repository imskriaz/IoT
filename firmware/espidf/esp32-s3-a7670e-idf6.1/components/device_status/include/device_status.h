...
#define DEVICE_STATUS_JSON_MAX_LEN 8192U
...
typedef struct {
    ...
    bool connection_development_mode;
    bool wifi_policy_enabled;
    bool modem_policy_enabled;
    bool concurrent_links_ready;
    ...
    uint32_t wifi_profiles_revision;
    uint8_t wifi_profiles_count;
    bool wifi_started;
    bool wifi_connected;
    ...
    char mqtt_last_error_text[UNIFIED_TEXT_MEDIUM_LEN];
    ...
    uint32_t storage_persist_failures;
    ...
    char modem_pdp_ip_address[UNIFIED_IPV4_ADDR_LEN];
