...
final class BridgeUi {
    ...
    // Shared compact density scale. Interactive controls keep a 44 dp touch target.
    static final int SPACE_TIGHT = 4;
    static final int SPACE_INLINE = 6;
    static final int SPACE_CONTROL = 8;
    static final int SPACE_CARD = 10;
    static final int SPACE_PAGE = 12;
    static final int TOUCH_TARGET = 44;
    ...
    static LinearLayout root(Context context) {
        ...
        root.setPadding(dp(context, SPACE_PAGE), dp(context, SPACE_PAGE), dp(context, SPACE_PAGE), dp(context, SPACE_PAGE));
    ...
    private static LinearLayout fixedBottomBar(Context context) {
        ...
        bar.setPadding(dp(context, SPACE_CONTROL), dp(context, SPACE_TIGHT), dp(context, SPACE_CONTROL), dp(context, SPACE_TIGHT));
    ...
    private static void addBottomItem(
        ...
        item.setMinimumHeight(dp(context, TOUCH_TARGET));
        item.setPadding(dp(context, SPACE_TIGHT), dp(context, 2), dp(context, SPACE_TIGHT), dp(context, 2));
        ...
        bar.addView(item, new LinearLayout.LayoutParams(0, dp(context, TOUCH_TARGET), 1f));
        if (addSpacer) {
    ...
    static View hero(Context context, String eyebrowText, String titleText, String copyText) {
        ...
        hero.setPadding(dp(context, SPACE_PAGE), dp(context, SPACE_CARD), dp(context, SPACE_PAGE), dp(context, SPACE_CARD));
    ...
    static LinearLayout sectionCard(Context context, String title, String subtitle) {
        ...
        card.setPadding(dp(context, SPACE_CARD), dp(context, SPACE_CARD), dp(context, SPACE_CARD), dp(context, SPACE_CARD));
        ...
        if (title != null && !title.isEmpty()) {
            ...
            LinearLayout.LayoutParams tp = fullWidth(context);
            tp.bottomMargin = (subtitle != null && !subtitle.isEmpty()) ? dp(context, 2) : dp(context, SPACE_INLINE);
        ...
        if (subtitle != null && !subtitle.isEmpty()) {
            ...
            subtitleView.setPadding(0, 0, 0, dp(context, SPACE_INLINE));
    ...
    static View spacer(Context context) {
        ...
        spacer.setLayoutParams(new LinearLayout.LayoutParams(dp(context, SPACE_INLINE), 1));
        return spacer;
    }
    ...
    static EditText input(Context context, String hint) {
        ...
        editText.setMinHeight(dp(context, TOUCH_TARGET));
        editText.setPadding(dp(context, SPACE_CARD), dp(context, SPACE_INLINE), dp(context, SPACE_CARD), dp(context, SPACE_INLINE));
    ...
    static TextView label(Context context, String value) {
        ...
        view.setPadding(0, dp(context, SPACE_INLINE), 0, dp(context, 2));
        return view;
    }
    ...
    static Button actionButton(Context context, String text, String backgroundColor, int textColor) {
        ...
        button.setPadding(dp(context, SPACE_CARD), dp(context, SPACE_INLINE), dp(context, SPACE_CARD), dp(context, SPACE_INLINE));
    ...
    static Button tinyButton(Context context, String text, String backgroundColor, int textColor) {
        ...
        button.setPadding(dp(context, SPACE_CONTROL), dp(context, SPACE_TIGHT), dp(context, SPACE_CONTROL), dp(context, SPACE_TIGHT));
        return button;
    }
    ...
    static View menuButton(Context context, String title, String detail, String accentColor) {
        ...
        row.setMinimumHeight(dp(context, TOUCH_TARGET));
        ...
        textCol.setPadding(dp(context, SPACE_CARD), dp(context, SPACE_CONTROL), dp(context, SPACE_CONTROL), dp(context, SPACE_CONTROL));
    ...
    static TextView statusPill(Context context, String text, String bgColor, String textColor) {
        ...
        view.setTextSize(scaledTextSize(11));
        view.setTypeface(Typeface.DEFAULT_BOLD);
        view.setPadding(dp(context, SPACE_INLINE), dp(context, 3), dp(context, SPACE_INLINE), dp(context, 3));
        GradientDrawable background = new GradientDrawable();
    ...
    static LinearLayout.LayoutParams fullWidth(Context context) {
        ...
        params.bottomMargin = dp(context, SPACE_INLINE);
        return params;
    }
