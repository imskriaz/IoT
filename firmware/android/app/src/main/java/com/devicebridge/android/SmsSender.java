...
final class SmsSender {
    ...
    static SendResult send(Context context, String actionId, String number, String text, int timeoutMs, Integer preferredSimSlot, Integer preferredSubscriptionId) {
        ...
        SmsSendTracker.Registration registration = SmsSendTracker.register(
                context, actionId, cleanNumber, parts.size(), timeoutMs);
        if (registration != SmsSendTracker.Registration.ACCEPTED) {
            return SendResult.rejected(registration.detail);
        }
    ...
    static String describeDetail(String detail) {
        ...
        switch (value) {
            ...
            case "sms_queue_full":
                return "The Android SMS queue is full; retry after pending sends finish.";
            case "sms_duplicate_action":
                return "This SMS action was already submitted; its existing result will be replayed.";
            case "sms_tracker_persistence_failed":
                return "SMS was not submitted because durable tracking could not be saved.";
            case "sms_invalid_action_id":
                return "A valid durable action ID is required.";
            default:
