    ...
    static List<FeatureSection> buildSections() {
        ...
        sections.add(new FeatureSection(
                ...
                items(
                        ...
                        new FeatureItem("Call telemetry and dial support", "Live", "Calls page", "Dashboard make-call commands can launch calls from the phone and call state changes can feed the dashboard."),
