...
const API_ROUTE_MOUNTS = [
    ...
    { file: 'hardware.js', basePath: '/api/devices', tag: 'Hardware' },
    { file: 'gpio.js', basePath: '/api/gpio', tag: 'GPIO' },
    { file: 'queue.js', basePath: '/api/queue', tag: 'Queue' },
    { file: 'notifications.js', basePath: '/api/notifications', tag: 'Notifications' }
];
...
module.exports = {
    ...
    toOpenApiPath,
    getCatalogRouteMounts: () => [...API_ROUTE_MOUNTS, ...SERVER_ROUTE_MOUNTS],
    getApiRouteMounts: () => [...API_ROUTE_MOUNTS]
};
