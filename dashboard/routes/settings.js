...
// Clear only device-related state so onboarding can be retested from a clean dashboard
router.post('/clear-device-data', adminMiddleware, async (req, res) => {
    try {
        ...
        await db.exec(`
            ...
            DELETE FROM gpio_groups;
            DELETE FROM gpio_rules;
            DELETE FROM pin_names;
            DELETE FROM notifications;
            DELETE FROM mqtt_logs;
            DELETE FROM system_logs;
            DELETE FROM storage_files;
            DELETE FROM intercom_settings;
            DELETE FROM intercom_calls;
            DELETE FROM intercom_sessions;
            DELETE FROM automation_flows;
            DELETE FROM automation_logs;
            DELETE FROM automation_data_records;
            DELETE FROM flow_execution_log;
            DELETE FROM device_module_health;
            DELETE FROM device_wifi_networks;
            DELETE FROM sims;
