...
describe('rendered dashboard pages', () => {
    ...
    test('renders SMS page HTML with compact conversation workspace and schedule controls', async () => {
        ...
        expect(html).toContain('class="sms-conversation-tools"');
        expect(html).toContain('class="sms-filter-tabs" id="quickFilterChips"');
        expect(html).toContain('class="sms-tab-count" id="smsTotalCount"');
        expect(html).not.toContain('sms-stats-row');
        expect(html).not.toContain('All Conversations</option>');
        ...
        expect(html).toContain('id="smsDetailsPanel"');
        ...
        expect(html).not.toContain("openContactsModal('smsChatTo')");
        expect(html).not.toContain("openContactsModal('modalTo')");
