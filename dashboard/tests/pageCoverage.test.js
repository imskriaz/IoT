...
describe('dashboard screen coverage', () => {
    ...
    test('Console command surface uses tabs with one dropdown and inline description', () => {
        ...
        expect(js).toContain("const MANUAL_EVENT_SOURCES = ['send', 'response', 'console', 'serial', 'serial-tx', 'serial-rx', 'error', 'scenario', 'wait', 'validation'];");
        ...
        expect(js).toContain("option.type === 'vendor'");
