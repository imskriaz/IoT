...
function printUsage() {
  console.log(`Usage:
  node .toolchain/share-vps-tunnel.js --host YOUR_VPS_IP --user root [options]
...
Examples:
  node .toolchain/share-vps-tunnel.js --host YOUR_VPS_IP --user root --public-url https://device.atebd.com --reconnect
  node .toolchain/share-vps-tunnel.js --host YOUR_VPS_IP --user root --forward 3000:3001,3010:3010,3011:3011 --reconnect
`);
}
